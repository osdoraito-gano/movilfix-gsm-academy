    ...
    <section className="relative py-28 px-6 text-center">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <p className="mt-6 text-lg md:text-xl text-slate-300 max-w-2xl mx-auto">
          Formación técnica real en electrónica móvil. Aprende diagnóstico,
          reparación avanzada y conviértete en técnico profesional desde
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
          ...
          <Link to="/tienda">
            <Button
              variant="outline"
              className="border-slate-600 text-white text-lg px-8 py-6"
            >
              Ver Tienda
            </Button>
          </Link>
        ...
        <div className="grid grid-cols-3 gap-6 mt-16 text-slate-300">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-sm">Reparación Avanzada</span>
          </div>

          <div className="flex flex-col items-center">
            <GraduationCap className="w-8 h-8 text-cyan-400 mb-2" />
            <span className="text-sm">Cursos Online</span>
          </div>

          <div className="flex flex-col items-center">
            <Wrench className="w-8 h-8 text-cyan-400 mb-2" />
            <span className="text-sm">Herramientas Profesionales</span>
          </div>
